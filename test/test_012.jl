...
using MechanicalUnits: @import_expand, ∙, ustrip, unit, ᴸ², NoDims, NoUnits
...
@testset "> Beam stiffness and flexibility matrices" begin
    ...
    K = convert_to_mixed(NoUnits.([kx        0N/m      0N        -kx       0N/m      0N;
                 0N/m      ky        -kθy      0N/m      -ky       -kθy;
                 0N        -kθy      2∙kθ      0N        kθy       kθ  ;
                 -kx       0N/m      0N        kx        0N/m      0N  ;
                  0N/m      -ky       kθy       0N/m      ky        kθy ;
                0N        -kθy      kθ        0N        kθy       2∙kθ]))
    K = convert_to_mixed([kx        00kN/mm     0kN        -kx       00kN/mm     0kN;
                00kN/mm     ky        -kθy      00kN/mm     -ky       -kθy;
                0kN        -kθy      2∙kθ      0kN        kθy       kθ  ;
                -kx       00kN/mm     0kN        kx        00kN/mm     0kN  ;
                00kN/mm     -ky       kθy       00kN/mm     ky        kθy ;
